...
public class Event implements Serializable {
  ...
  @OneToMany(mappedBy = "event") @JsonIgnore private List<Receipt> receipts;

  // bi-directional many-to-one association to Ticket
  @OneToMany(mappedBy = "event") @JsonIgnore private List<Ticket> ticketsSet;
  ...
  public Category getCategoryBean() { return this.categoryBean; }
  ...
  public List<Ticket> getTicketsSet() { return this.ticketsSet; }
